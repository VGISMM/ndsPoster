The proposed system is evaluated on xxx day and xxx night time frames. In Table \ref{systemOverview::derivedSemantics:Results} the results is seen, where GT is the ground truth of NDS events manually labeled and SO is the system output.
%\begin{table}
%\caption{ }  
