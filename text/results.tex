...
%\begin{figure}[h]
%\centering
%     \includegraphics[width=0.2\textwidth]{text/figures/lefttrun2cars.png}
%     \caption{Partially occluded vehicle detected in a left turn.}
%     \label{fig:results:twoCars}
%\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=0.9\textwidth]{text/figures/lefttrun2cars.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.9\textwidth]{text/figures/distanceCarEvent.png}
