...
Using the camera's focal length and baseline, along with the calculated disparity, the actual distance to objects in the camera's view can be found. %The remaining $x$ and $y$ component of the world coordinate are found using the column and row index of the disparity pixel.
