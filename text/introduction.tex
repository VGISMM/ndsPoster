...
\begin{figure}[H]
  ...
  \begin{tabular}{ccc}
    ...
    \subfloat[\tiny{Other vehicle entering intersection - turning onto same direction.}]{\includegraphics[width=0.28\textwidth]{text/figures/passingIntersectOntoSameDirection.png} \label{fig:introduction:semantics:f}}
  \end{tabular}
