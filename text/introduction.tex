...
\begin{figure}[H]
  ...
  \end{tabular}
  \caption{\scriptsize{Critical events that can be automatically detected by the proposed method. Green car is ego vehicle moving towards intersection. Red cars are other vehicles.\cite{philipsen2015NDS} } 
