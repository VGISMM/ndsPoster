...
\begin{posterbox}[name=relatedWork,column=1,span=2]{Related Work}
%\input{text/abstract.tex}
\input{text/relatedWork.tex}
\end{posterbox}

\begin{posterbox}[name=propsedMethod,column=1,span=2,below=relatedWork]{Proposed System}
...
\begin{posterbox}[name=references,column=0,below=introduction]{References}
