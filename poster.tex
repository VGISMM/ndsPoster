...
% For UCSD EXPO
\documentclass[paperwidth=90cm,paperheight=130cm,landscape,12pt]{preambles/baposter}
...
%the author(s)
{\color{white}\large
  \vspace{0.7em} \textit{Mark P. Philipsen}, \textit{Morten B. Jensen}, \textit{Ravi K. Satzoda},\\ \textit{Andreas Møgelmose*}, \textit{Mohan M. Trivedi} \& \textit{Thomas B. Moeslund} %\\[0.7em]
 %   \vspace{0.7em} \begin{large} \textit{Mark P. Philipsen}, \textit{Morten B. Jensen}, \textit{Ravi K. Satzoda}, \textit{Andreas Møgelmose}, \textit{Mohan M. Trivedi} \& \textit{Thomas B. Moeslund} \end{large} %\\[0.7em]
...
\begin{posterbox}[name=relatedWork,column=0,span=1,below=introduction]{Related Work}
%\input{text/abstract.tex}
...
\begin{posterbox}[name=results,column=1,span=2,below=propsedMethod]{Results}
\input{text/results.tex}
\end{posterbox}

\begin{posterbox}[name=conclusion,column=1,span=2,below=results]{Concluding Remarks}
\input{text/conclusion.tex}
\end{posterbox}

\begin{posterbox}[name=acknowledgment,column=0,below=relatedWork]{Acknowledgment}
...
\begin{posterbox}[name=references,column=1,span=2,below=conclusion]{References}
